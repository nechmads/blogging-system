/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b342d405178a890aeb464a79d9f3dc2b)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SCOUT_WORKFLOW: Workflow<Parameters<import("./src/index").ScoutWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALEXANDER_API_URL" | "WRITER_AGENT_URL">> {}
}
