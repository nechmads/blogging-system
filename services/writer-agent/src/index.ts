...
import { healthRoutes, sessionRoutes, draftRoutes, chatRoutes, publishRoutes, publicationRoutes, topicRoutes, ideaRoutes, activityRoutes, imageRoutes } from './routes'
