      ...
      <div className="mb-6">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex shrink-0 items-center gap-1.5 rounded-lg bg-[var(--color-accent)] px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-[var(--color-accent-hover)]"
          >
            <PlusIcon size={16} />
            Create Style
          </button>
