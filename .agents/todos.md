...
- [ ] DAL Service — Phase 4: Migrate content-scout to use DAL via Service Binding
- [ ] DAL Service — Phase 5: Migrate publisher to use DAL via Service Binding
- [ ] DAL Service — Phase 6: Verify & clean up (remove old D1 bindings, manager classes, retry utils)
